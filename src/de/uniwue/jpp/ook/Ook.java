...
/**
 * Diese Schnittstelle beschreibt das gesamte Programm.
 */
public interface Ook {
    ...
    static void main(String[] args) throws IOException {
        if(args.length == 3){
            ...
            create().createShell(System.in, System.out).run();
        }
    }
    ...
    default Shell createShell(InputStream input, OutputStream output) {
        return Shell.create(this, input, output);
    }
